<template>
    <div
        ...
        <div class="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
            ...
            <div class="relative z-20 flex items-center text-2xl font-bold site-header-register" href="/">GuOJ</div>
        ...
        <div class="relative h-full flex-col items-center justify-center grid">
            ...
            <div class="absolute register-btn-container p-8">
                ...
                <Button v-on:click="navigateTo('/login')">
                    Login
                </Button>
            </div>
